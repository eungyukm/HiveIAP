...
namespace hive
{
    public partial class ResultAPI {
		...
		public enum Code : int {
			...
			PlatformHelperNotSupported = -7000004,		///< [PlatformHelper] Not supported. : %1
        	PlatformHelperInvalidParam = -7000005,		///< [PlatformHelper] Invalid parameter. : %1
			...
			AnalyticsConsentModeCanceled = -9000001, ///< [Analytics] ConsentMode Canceled.
			// RESULT API END
		}
